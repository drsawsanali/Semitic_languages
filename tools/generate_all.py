...
# -*- coding: utf-8 -*-
"""
Semitic Atlas - Complete Generator
...
language_families = [
  {
    ...
    "linguisticFeatures": [
      ...
      { "title": { "ar": "اندماج الحلقيات", "en": "Pharyngeal Mergers" }, "description": { "ar": "تحول صوامت الحلق والحنجرة إلى حركات مُمَالة ومطوّلة.", "en": "Weakening and merger of gutturals affecting adjacent vowel qualities." } }
    ]
  },
  {
    ...
    "linguisticFeatures": [
      ...
      { "title": { "ar": "واو العطف السردية", "en": "Waw-Consecutive" }, "description": { "ar": "استخدام واو العطف التتابعية لتغيير زمن الفعل في السرد.", "en": "Narrative sequential waw altering verbal aspect." } }
    ]
  },
  {
    "id": "aramaic",
    ...
    "period": { "start": "-1000", "end": null, "display": { "ar": "1000 ق.م – مستمرة", "en": "1000 BCE – Present" } },
    "linguisticFeatures": [
      { "title": { "ar": "أداة التعريف اللاحقة (-ā)", "en": "Postpositive Definite Article" }, "description": { "ar": "إلحاق الألف في نهاية الاسم كأداة تعريف وتأكيد (حالة الإطلاق والإثبات).", "en": "Suffixed aleph (-ā) marking the emphatic/determinate state." } },
  ...
  },
  {
    ...
    "period": { "start": "-0600", "end": null, "display": { "ar": "منذ القرن 6 ق.م – مستمرة", "en": "6th century BCE – Present" } }
  },
  {
  ...
  },
  {
    ...
    "period": { "start": "0001", "end": null, "display": { "ar": "لغات شفهية حية مستمرة", "en": "Living oral traditions" } }
  },
  {
    "id": "ethiosemitic",
    ...
    "period": { "start": "-0500", "end": null, "display": { "ar": "500 ق.م – مستمرة", "en": "500 BCE – Present" } }
  }
]
write_json("data/language-families.json", language_families)

print("Language families generated.")
